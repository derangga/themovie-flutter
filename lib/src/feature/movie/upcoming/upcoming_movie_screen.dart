...
import 'package:themovie_flutter/src/widget/footer_progress.dart';
...
class _UpcomingMovieScreenState extends BaseStateWidget<UpcomingMovieBloc,
  ...
  @override
  Widget mapStateToWidget(UpcomingMovieState state) {
